...
export class InitTrafficLights {
	...
	constructor() {
		...
		this.trafficLightArr.push(new TrafficLight(8.6, 0.07, 0, 3, 5, "cycle", 0, 2));
		this.trafficLightArr.push(new TrafficLight(10.0, -0.63, 0, 4, 5, "cycle", 0, 2));
		...
		this.trafficLightArr.push(new TrafficLight(8.6, 0.21, 0, 3, 9, "foot", 0, 2));
		this.trafficLightArr.push(new TrafficLight(10.0, -0.77, 0, 4, 9, "foot", 0, 2));
	}
